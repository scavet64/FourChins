...
namespace FChan.Library
{
    ...
    public static class Constants
    {
        ...
        /// The board URL.
        /// </summary>
        public const string BoardsUrl = "https://a.4cdn.org/boards.json";
        ...
        /// The threads URL.
        /// </summary>
        public const string ThreadsUrl = "https://a.4cdn.org/{0}/threads.json";
        ...
        /// <summary>
        /// Gets the threads URL.
        /// </summary>
        /// <returns>The thread URL.</returns>
        /// <param name="board">Board.</param>
        public static string GetThreadsUrl(string board)
        {
            return string.Format(ThreadsUrl, board);
        }
    }
}
